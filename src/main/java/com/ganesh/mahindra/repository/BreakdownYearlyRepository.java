...
*/
	@Query(value="select SUM(1) as id,coalesce((select count(*) as breakdown_count1 from why_why_f18 where  date between :fromFirstYear and :toFirstYear ),0) as first_year, coalesce((select count(*) as breakdown_count2 from why_why_f18 where  date between :fromSecondYear and :toSecondYear ),0) as second_year, coalesce((select count(*) as breakdown_count3 from why_why_f18 where  date between :fromThirdYear and :toThirdYear ),0) as third_year, coalesce((select count(*) as breakdown_count4 from why_why_f18 where  date between :fromFourthYear and :toFourthYear ),0) as fourth_year from why_why_f18",nativeQuery=true)
	...
	@Query(value="select SUM(1) as id,coalesce((select count(*) as breakdown_count1 from why_why_f18 where rank=1 and date between :fromFirstYear and :toFirstYear ),0) as first_year, coalesce((select count(*) as breakdown_count2 from why_why_f18 where rank=1 and  date between :fromSecondYear and :toSecondYear ),0) as second_year, coalesce((select count(*) as breakdown_count3 from why_why_f18 where rank=1 and date between :fromThirdYear and :toThirdYear ),0) as third_year, coalesce((select count(*) as breakdown_count4 from why_why_f18 where rank=1 and date between :fromFourthYear and :toFourthYear ),0) as fourth_year from why_why_f18",nativeQuery=true)
